    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAvatarImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAvatarImages_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GlobalNotifications_Admins_AdminId",
                        column: x => x.AdminId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cycles_Authors_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WritingStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAvatarImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookAvatarImages_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookAvatarImages_BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cycles_AuthorId",
                table: "Cycles",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_GlobalNotifications_AdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAvatarImages_UserId",
